    ...
    return (
      <div className="bg">
        <div className="matchDiv">
          <img src={imageurl} alt="match" className="bigImage" />
        </div>

        <div>
          <ul className="names">
            {tabsList.map(tabslist => (
              <TabItem
                key={tabslist.tabId}
                tabDetails={tabslist}
        ...
        <div className="displayimagesdiv">
          <ul className="lists">
            {filteredImages.map(each => (
              <ImageItem
                key={each.id}
                imageDetails={each}
                matching={this.renderimage(each.thumbnailUrl)}
              />
            ))}
          </ul>
        </div>
        ...
        <ul className="nav">
          ...
          <li className="scorediv">
            {game ? (
              ...
              <p className="score">
                Your score:<span className="span">{score}</span>
              </p>
            )}
            <img
            ...
            />
            <p className="sec">
              <p className="span">{timer}</p>sec
            </p>
          </li>
        </ul>

        <div>{game ? this.randergame() : this.renderscore()}</div>
      </div>
    )
  }
}
